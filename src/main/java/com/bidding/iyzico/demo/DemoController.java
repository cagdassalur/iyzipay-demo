package com.bidding.iyzico.demo;
...
public class DemoController {
    ...
    CheckoutFormInitialize test() {
        ...
        options.setApiKey("sandbox-3IrPaFzTqZVxUFfywjFQdNf5OWOB5Iiv");
        options.setSecretKey("sandbox-dFIkLaQJDnTKV7PamturSJdzw47f2NmT");
